...
alias DUCKDB_TYPE_INVALID = duckdb_type.DUCKDB_TYPE_INVALID;
alias DUCKDB_TYPE_BOOLEAN = duckdb_type.DUCKDB_TYPE_BOOLEAN;
alias DUCKDB_TYPE_TINYINT = duckdb_type.DUCKDB_TYPE_TINYINT;
alias DUCKDB_TYPE_SMALLINT = duckdb_type.DUCKDB_TYPE_SMALLINT;
alias DUCKDB_TYPE_INTEGER = duckdb_type.DUCKDB_TYPE_INTEGER;
alias DUCKDB_TYPE_BIGINT = duckdb_type.DUCKDB_TYPE_BIGINT;
alias DUCKDB_TYPE_UTINYINT = duckdb_type.DUCKDB_TYPE_UTINYINT;
alias DUCKDB_TYPE_USMALLINT = duckdb_type.DUCKDB_TYPE_USMALLINT;
alias DUCKDB_TYPE_UINTEGER = duckdb_type.DUCKDB_TYPE_UINTEGER;
alias DUCKDB_TYPE_UBIGINT = duckdb_type.DUCKDB_TYPE_UBIGINT;
alias DUCKDB_TYPE_FLOAT = duckdb_type.DUCKDB_TYPE_FLOAT;
alias DUCKDB_TYPE_DOUBLE = duckdb_type.DUCKDB_TYPE_DOUBLE;
alias DUCKDB_TYPE_TIMESTAMP = duckdb_type.DUCKDB_TYPE_TIMESTAMP;
alias DUCKDB_TYPE_DATE = duckdb_type.DUCKDB_TYPE_DATE;
alias DUCKDB_TYPE_TIME = duckdb_type.DUCKDB_TYPE_TIME;
alias DUCKDB_TYPE_INTERVAL = duckdb_type.DUCKDB_TYPE_INTERVAL;
alias DUCKDB_TYPE_HUGEINT = duckdb_type.DUCKDB_TYPE_HUGEINT;
alias DUCKDB_TYPE_UHUGEINT = duckdb_type.DUCKDB_TYPE_UHUGEINT;
alias DUCKDB_TYPE_VARCHAR = duckdb_type.DUCKDB_TYPE_VARCHAR;
alias DUCKDB_TYPE_BLOB = duckdb_type.DUCKDB_TYPE_BLOB;
alias DUCKDB_TYPE_DECIMAL = duckdb_type.DUCKDB_TYPE_DECIMAL;
alias DUCKDB_TYPE_TIMESTAMP_S = duckdb_type.DUCKDB_TYPE_TIMESTAMP_S;
alias DUCKDB_TYPE_TIMESTAMP_MS = duckdb_type.DUCKDB_TYPE_TIMESTAMP_MS;
alias DUCKDB_TYPE_TIMESTAMP_NS = duckdb_type.DUCKDB_TYPE_TIMESTAMP_NS;
alias DUCKDB_TYPE_ENUM = duckdb_type.DUCKDB_TYPE_ENUM;
alias DUCKDB_TYPE_LIST = duckdb_type.DUCKDB_TYPE_LIST;
alias DUCKDB_TYPE_STRUCT = duckdb_type.DUCKDB_TYPE_STRUCT;
alias DUCKDB_TYPE_MAP = duckdb_type.DUCKDB_TYPE_MAP;
alias DUCKDB_TYPE_ARRAY = duckdb_type.DUCKDB_TYPE_ARRAY;
alias DUCKDB_TYPE_UUID = duckdb_type.DUCKDB_TYPE_UUID;
alias DUCKDB_TYPE_UNION = duckdb_type.DUCKDB_TYPE_UNION;
alias DUCKDB_TYPE_BIT = duckdb_type.DUCKDB_TYPE_BIT;
alias DUCKDB_TYPE_TIME_TZ = duckdb_type.DUCKDB_TYPE_TIME_TZ;
alias DUCKDB_TYPE_TIMESTAMP_TZ = duckdb_type.DUCKDB_TYPE_TIMESTAMP_TZ;
alias DUCKDB_TYPE_ANY = duckdb_type.DUCKDB_TYPE_ANY;
alias DUCKDB_TYPE_VARINT = duckdb_type.DUCKDB_TYPE_VARINT;
alias DUCKDB_TYPE_SQLNULL = duckdb_type.DUCKDB_TYPE_SQLNULL;

//! An enum over the returned state of different functions.
enum duckdb_state { DuckDBSuccess = 0, DuckDBError = 1 }
alias DuckDBSuccess = duckdb_state.DuckDBSuccess;
alias DuckDBError = duckdb_state.DuckDBError;
...
alias DUCKDB_PENDING_RESULT_READY = duckdb_pending_state.DUCKDB_PENDING_RESULT_READY;
alias DUCKDB_PENDING_RESULT_NOT_READY = duckdb_pending_state.DUCKDB_PENDING_RESULT_NOT_READY;
alias DUCKDB_PENDING_ERROR = duckdb_pending_state.DUCKDB_PENDING_ERROR;
alias DUCKDB_PENDING_NO_TASKS_AVAILABLE = duckdb_pending_state.DUCKDB_PENDING_NO_TASKS_AVAILABLE;
...
alias DUCKDB_RESULT_TYPE_INVALID = duckdb_result_type.DUCKDB_RESULT_TYPE_INVALID;
alias DUCKDB_RESULT_TYPE_CHANGED_ROWS = duckdb_result_type.DUCKDB_RESULT_TYPE_CHANGED_ROWS;
alias DUCKDB_RESULT_TYPE_NOTHING = duckdb_result_type.DUCKDB_RESULT_TYPE_NOTHING;
alias DUCKDB_RESULT_TYPE_QUERY_RESULT = duckdb_result_type.DUCKDB_RESULT_TYPE_QUERY_RESULT;
...
alias DUCKDB_STATEMENT_TYPE_INVALID = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_INVALID;
alias DUCKDB_STATEMENT_TYPE_SELECT = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_SELECT;
alias DUCKDB_STATEMENT_TYPE_INSERT = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_INSERT;
alias DUCKDB_STATEMENT_TYPE_UPDATE = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_UPDATE;
alias DUCKDB_STATEMENT_TYPE_EXPLAIN = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_EXPLAIN;
alias DUCKDB_STATEMENT_TYPE_DELETE = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_DELETE;
alias DUCKDB_STATEMENT_TYPE_PREPARE = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_PREPARE;
alias DUCKDB_STATEMENT_TYPE_CREATE = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_CREATE;
alias DUCKDB_STATEMENT_TYPE_EXECUTE = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_EXECUTE;
alias DUCKDB_STATEMENT_TYPE_ALTER = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_ALTER;
alias DUCKDB_STATEMENT_TYPE_TRANSACTION = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_TRANSACTION;
alias DUCKDB_STATEMENT_TYPE_COPY = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_COPY;
alias DUCKDB_STATEMENT_TYPE_ANALYZE = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_ANALYZE;
alias DUCKDB_STATEMENT_TYPE_VARIABLE_SET = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_VARIABLE_SET;
alias DUCKDB_STATEMENT_TYPE_CREATE_FUNC = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_CREATE_FUNC;
alias DUCKDB_STATEMENT_TYPE_DROP = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_DROP;
alias DUCKDB_STATEMENT_TYPE_EXPORT = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_EXPORT;
alias DUCKDB_STATEMENT_TYPE_PRAGMA = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_PRAGMA;
alias DUCKDB_STATEMENT_TYPE_VACUUM = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_VACUUM;
alias DUCKDB_STATEMENT_TYPE_CALL = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_CALL;
alias DUCKDB_STATEMENT_TYPE_SET = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_SET;
alias DUCKDB_STATEMENT_TYPE_LOAD = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_LOAD;
alias DUCKDB_STATEMENT_TYPE_RELATION = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_RELATION;
alias DUCKDB_STATEMENT_TYPE_EXTENSION = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_EXTENSION;
alias DUCKDB_STATEMENT_TYPE_LOGICAL_PLAN = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_LOGICAL_PLAN;
alias DUCKDB_STATEMENT_TYPE_ATTACH = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_ATTACH;
alias DUCKDB_STATEMENT_TYPE_DETACH = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_DETACH;
alias DUCKDB_STATEMENT_TYPE_MULTI = duckdb_statement_type.DUCKDB_STATEMENT_TYPE_MULTI;
...
alias DUCKDB_ERROR_INVALID = duckdb_error_type.DUCKDB_ERROR_INVALID;
alias DUCKDB_ERROR_OUT_OF_RANGE = duckdb_error_type.DUCKDB_ERROR_OUT_OF_RANGE;
alias DUCKDB_ERROR_CONVERSION = duckdb_error_type.DUCKDB_ERROR_CONVERSION;
alias DUCKDB_ERROR_UNKNOWN_TYPE = duckdb_error_type.DUCKDB_ERROR_UNKNOWN_TYPE;
alias DUCKDB_ERROR_DECIMAL = duckdb_error_type.DUCKDB_ERROR_DECIMAL;
alias DUCKDB_ERROR_MISMATCH_TYPE = duckdb_error_type.DUCKDB_ERROR_MISMATCH_TYPE;
alias DUCKDB_ERROR_DIVIDE_BY_ZERO = duckdb_error_type.DUCKDB_ERROR_DIVIDE_BY_ZERO;
alias DUCKDB_ERROR_OBJECT_SIZE = duckdb_error_type.DUCKDB_ERROR_OBJECT_SIZE;
alias DUCKDB_ERROR_INVALID_TYPE = duckdb_error_type.DUCKDB_ERROR_INVALID_TYPE;
alias DUCKDB_ERROR_SERIALIZATION = duckdb_error_type.DUCKDB_ERROR_SERIALIZATION;
alias DUCKDB_ERROR_TRANSACTION = duckdb_error_type.DUCKDB_ERROR_TRANSACTION;
alias DUCKDB_ERROR_NOT_IMPLEMENTED = duckdb_error_type.DUCKDB_ERROR_NOT_IMPLEMENTED;
alias DUCKDB_ERROR_EXPRESSION = duckdb_error_type.DUCKDB_ERROR_EXPRESSION;
alias DUCKDB_ERROR_CATALOG = duckdb_error_type.DUCKDB_ERROR_CATALOG;
alias DUCKDB_ERROR_PARSER = duckdb_error_type.DUCKDB_ERROR_PARSER;
alias DUCKDB_ERROR_PLANNER = duckdb_error_type.DUCKDB_ERROR_PLANNER;
alias DUCKDB_ERROR_SCHEDULER = duckdb_error_type.DUCKDB_ERROR_SCHEDULER;
alias DUCKDB_ERROR_EXECUTOR = duckdb_error_type.DUCKDB_ERROR_EXECUTOR;
alias DUCKDB_ERROR_CONSTRAINT = duckdb_error_type.DUCKDB_ERROR_CONSTRAINT;
alias DUCKDB_ERROR_INDEX = duckdb_error_type.DUCKDB_ERROR_INDEX;
alias DUCKDB_ERROR_STAT = duckdb_error_type.DUCKDB_ERROR_STAT;
alias DUCKDB_ERROR_CONNECTION = duckdb_error_type.DUCKDB_ERROR_CONNECTION;
alias DUCKDB_ERROR_SYNTAX = duckdb_error_type.DUCKDB_ERROR_SYNTAX;
alias DUCKDB_ERROR_SETTINGS = duckdb_error_type.DUCKDB_ERROR_SETTINGS;
alias DUCKDB_ERROR_BINDER = duckdb_error_type.DUCKDB_ERROR_BINDER;
alias DUCKDB_ERROR_NETWORK = duckdb_error_type.DUCKDB_ERROR_NETWORK;
alias DUCKDB_ERROR_OPTIMIZER = duckdb_error_type.DUCKDB_ERROR_OPTIMIZER;
alias DUCKDB_ERROR_NULL_POINTER = duckdb_error_type.DUCKDB_ERROR_NULL_POINTER;
alias DUCKDB_ERROR_IO = duckdb_error_type.DUCKDB_ERROR_IO;
alias DUCKDB_ERROR_INTERRUPT = duckdb_error_type.DUCKDB_ERROR_INTERRUPT;
alias DUCKDB_ERROR_FATAL = duckdb_error_type.DUCKDB_ERROR_FATAL;
alias DUCKDB_ERROR_INTERNAL = duckdb_error_type.DUCKDB_ERROR_INTERNAL;
alias DUCKDB_ERROR_INVALID_INPUT = duckdb_error_type.DUCKDB_ERROR_INVALID_INPUT;
alias DUCKDB_ERROR_OUT_OF_MEMORY = duckdb_error_type.DUCKDB_ERROR_OUT_OF_MEMORY;
alias DUCKDB_ERROR_PERMISSION = duckdb_error_type.DUCKDB_ERROR_PERMISSION;
alias DUCKDB_ERROR_PARAMETER_NOT_RESOLVED = duckdb_error_type.DUCKDB_ERROR_PARAMETER_NOT_RESOLVED;
alias DUCKDB_ERROR_PARAMETER_NOT_ALLOWED = duckdb_error_type.DUCKDB_ERROR_PARAMETER_NOT_ALLOWED;
alias DUCKDB_ERROR_DEPENDENCY = duckdb_error_type.DUCKDB_ERROR_DEPENDENCY;
alias DUCKDB_ERROR_HTTP = duckdb_error_type.DUCKDB_ERROR_HTTP;
alias DUCKDB_ERROR_MISSING_EXTENSION = duckdb_error_type.DUCKDB_ERROR_MISSING_EXTENSION;
alias DUCKDB_ERROR_AUTOLOAD = duckdb_error_type.DUCKDB_ERROR_AUTOLOAD;
alias DUCKDB_ERROR_SEQUENCE = duckdb_error_type.DUCKDB_ERROR_SEQUENCE;
alias DUCKDB_INVALID_CONFIGURATION = duckdb_error_type.DUCKDB_INVALID_CONFIGURATION;

//! An enum over DuckDB's different cast modes.
enum duckdb_cast_mode { DUCKDB_CAST_NORMAL = 0, DUCKDB_CAST_TRY = 1 }
alias DUCKDB_CAST_NORMAL = duckdb_cast_mode.DUCKDB_CAST_NORMAL;
alias DUCKDB_CAST_TRY = duckdb_cast_mode.DUCKDB_CAST_TRY;
...
struct duckdb_query_progress_type {
	double percentage = 0;
	ulong rows_processed;
	ulong total_rows_to_process;
}
...
alias duckdb_scalar_function_t = void function(duckdb_function_info info, duckdb_data_chunk input, duckdb_vector output);
...
alias duckdb_aggregate_init_t = void function(duckdb_function_info info, duckdb_aggregate_state state);
//! Destroy aggregate state (optional)
alias duckdb_aggregate_destroy_t = void function(duckdb_aggregate_state* states, idx_t count);
//! Update a set of aggregate states with new values
alias duckdb_aggregate_update_t = void function(duckdb_function_info info, duckdb_data_chunk input, duckdb_aggregate_state* states);
//! Combine aggregate states
alias duckdb_aggregate_combine_t = void function(duckdb_function_info info, duckdb_aggregate_state* source, duckdb_aggregate_state* target, idx_t count);
//! Finalize aggregate states into a result vector
alias duckdb_aggregate_finalize_t = void function(duckdb_function_info info, duckdb_aggregate_state* source, duckdb_vector result, idx_t count, idx_t offset);
...
alias duckdb_table_function_init_t = void function(duckdb_init_info info);

//! The main function of the table function.
alias duckdb_table_function_t = void function(duckdb_function_info info, duckdb_data_chunk output);
...
version (DUCKDB_API_NO_DEPRECATED) {} else {
/*!
...
*/
duckdb_time_tz duckdb_create_time_tz(long micros, int offset);
...
*/
duckdb_decimal duckdb_double_to_decimal(double val, ubyte width, ubyte scale);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_int8(byte input);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_uint8(ubyte input);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_int16(short input);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_uint16(ushort input);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_int32(int input);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_uint32(uint input);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_uint64(ulong input);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_int64(long val);
...
* @return The value. This must be destroyed with `duckdb_destroy_value`.
*/
duckdb_value duckdb_create_blob(const(ubyte)* data, idx_t length);
...
*/
void duckdb_logical_type_set_alias(duckdb_logical_type type, const(char)* alias_);
...
* @return The logical type.
*/
duckdb_logical_type duckdb_create_decimal_type(ubyte width, ubyte scale);
...
*/
ulong* duckdb_vector_get_validity(duckdb_vector vector);
...
*/
bool duckdb_validity_row_is_valid(ulong* validity, idx_t row);
...
*/
void duckdb_validity_set_row_validity(ulong* validity, idx_t row, bool valid);
...
* @param row The row index
*/
void duckdb_validity_set_row_invalid(ulong* validity, idx_t row);
...
* @param row The row index
*/
void duckdb_validity_set_row_valid(ulong* validity, idx_t row);
...
*/
void duckdb_scalar_function_set_function(duckdb_scalar_function scalar_function, duckdb_scalar_function_t function_);
...
*/
duckdb_state duckdb_add_scalar_function_to_set(duckdb_scalar_function_set set, duckdb_scalar_function function_);
...
* @param function The function to add
*/
duckdb_state duckdb_add_aggregate_function_to_set(duckdb_aggregate_function_set set, duckdb_aggregate_function function_);
...
* @param function The function
*/
void duckdb_table_function_set_function(duckdb_table_function table_function, duckdb_table_function_t function_);
...
* @return Whether or not the registration was successful.
*/
duckdb_state duckdb_register_table_function(duckdb_connection con, duckdb_table_function function_);
...
* @return `DuckDBSuccess` on success or `DuckDBError` on failure.
*/
duckdb_state duckdb_table_description_create(duckdb_connection connection, const(char)* schema, const(char)* table, duckdb_table_description* out_);
...
* @return `DuckDBSuccess` on success or `DuckDBError` on failure.
*/
duckdb_state duckdb_column_has_default(duckdb_table_description table_description, idx_t index, bool* out_);
...
*/
void duckdb_cast_function_set_implicit_cast_cost(duckdb_cast_function cast_function, long cost);
...
*/
void duckdb_cast_function_set_function(duckdb_cast_function cast_function, duckdb_cast_function_t function_);
